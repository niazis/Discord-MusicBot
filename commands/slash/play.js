...
const command = new SlashCommand()
  ...
  .setRun(async (client, interaction, options) => {
    ...
    if (channel.type == "GUILD_STAGE_VOICE") {
      setTimeout(() => {
        if (interaction.guild.members.members.me.voice.suppress == true) {
          try {
            interaction.guild.members.members.me.voice.setSuppressed(false);
          } catch (e) {
            interaction.guild.members.members.me.voice.setRequestToSpeak(true);
          }
        }
